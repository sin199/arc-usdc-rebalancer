...
import { architectsPacketActions, architectsPacketChecklist, architectsPacketEvidence, architectsPacketSummary } from '@/lib/architects-packet'
        ...
        <Card className="border-primary/20 bg-primary/5">
          <CardHeader className="space-y-3">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Badge variant="success">Robot brief</Badge>
              <Badge variant="outline" className="border-white/15 bg-white/5 text-foreground">
                Not a badge claim
              </Badge>
            </div>
