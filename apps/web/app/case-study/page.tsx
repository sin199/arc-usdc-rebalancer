...
const replaySteps = [
  {
    ...
    detail:
      'Start here if you want the 3-minute explanation before looking at the live checker.',
  },
  {
    title: 'Open the dashboard',
    detail:
      'Generate a readiness report from the current balance and policy inputs.',
  },
  {
    title: 'Compare the scenarios',
    detail:
      'Use the sample states to see how the same report changes when the balance moves.',
  },
  {
    title: 'Inspect the evidence',
    detail:
      'Check the report markdown, the notes page, and the repo trail before judging the build.',
  },
]
      ...
      <section className="mx-auto flex w-full max-w-screen-2xl flex-col gap-6 px-4 pb-8 pt-2 sm:px-6 lg:px-8">
        <Card className="border-primary/20 bg-primary/5">
          <CardHeader className="space-y-2">
            ...
            <CardDescription className="max-w-3xl">
              {projectTrailSummary.headline} The point of this page is to make
              the verified demo easy to replay without opening every surface
              first.
            </CardDescription>
          </CardHeader>
          <CardContent className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
            <div className="rounded-2xl border border-white/10 bg-background/50 p-4">
              ...
              <div className="mt-2 text-sm leading-6 text-foreground">
                Operators can open one public page and see the report path, the
                live policy path, and the operator gate without guessing where
                to click next.
              </div>
            </div>
            <div className="rounded-2xl border border-white/10 bg-background/50 p-4">
        ...
        <Card className="border-primary/20 bg-primary/5">
          <CardHeader className="space-y-2">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Badge variant="outline">No transactions submitted</Badge>
            </div>
            <CardTitle>Reproducible decision and safety evidence</CardTitle>
            <CardDescription>
              The CLI, automated test, API, and this page all use the same
              shared backtest implementation.
            </CardDescription>
          </CardHeader>
          <CardContent className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-2xl border border-white/10 bg-background/50 p-4">
              ...
              <div className="mt-2 text-2xl font-semibold text-foreground">
                {backtest.balanceSweep.cases.toLocaleString()}
              </div>
            </div>
            <div className="rounded-2xl border border-white/10 bg-background/50 p-4">
              <div className="text-xs uppercase tracking-[0.18em] text-muted-foreground">
              ...
              <div className="mt-2 text-2xl font-semibold text-foreground">
                {(backtest.balanceSweep.decisionAgreementRate * 100).toFixed(2)}
                %
              </div>
            </div>
            <div className="rounded-2xl border border-white/10 bg-background/50 p-4">
              ...
              <div className="mt-2 text-2xl font-semibold text-foreground">
                {backtest.safetyGates.passed}/{backtest.safetyGates.cases}
              </div>
            </div>
            <div className="rounded-2xl border border-white/10 bg-background/50 p-4">
              <div className="text-xs uppercase tracking-[0.18em] text-muted-foreground">
              ...
              <div className="mt-2 text-2xl font-semibold text-foreground">
                {backtest.balanceSweep.capViolations}
              </div>
            </div>
            <div className="rounded-2xl border border-white/10 bg-background/50 p-4 text-sm leading-6 text-muted-foreground sm:col-span-2 lg:col-span-4">
        ...
        <div className="grid gap-6 lg:grid-cols-[1.08fr_0.92fr]">
          <Card className="border-white/10 bg-card/85">
            <CardHeader>
              ...
              <CardDescription>
                Four steps, one short path, no extra context needed.
              </CardDescription>
            </CardHeader>
          ...
          <Card className="border-white/10 bg-card/85">
            <CardHeader>
              ...
              <CardDescription>
                The fastest way to tell whether the project is useful is to
        ...
        <div className="grid gap-6 lg:grid-cols-[0.92fr_1.08fr]">
          ...
          <Card className="border-white/10 bg-card/85">
            <CardHeader>
              ...
              <CardDescription>
                These are the exact items to verify before you call the build
                useful or not.
              </CardDescription>
            </CardHeader>
            <CardContent className="grid gap-3 md:grid-cols-2">
              ...
              >
                ...
                <div className="mt-2 text-sm text-foreground">
                  Generate the report and inspect the evidence grid.
                </div>
              </a>
              <a
                href="/notes"
              ...
              >
                ...
                <div className="mt-2 text-sm text-foreground">
                  Read the maintenance trail and known gaps.
                </div>
              </a>
              <a
        ...
        <Card className="border-white/10 bg-card/85">
          <CardHeader>
            ...
            <CardDescription>
              Use the links below when you want to move from reading to checking
              the live demo.
            </CardDescription>
          </CardHeader>
          <CardContent className="flex flex-wrap gap-3">
            ...
            {projectReferenceLinks
              .filter((link) => link.href !== '/case-study')
              .map((link) => (
