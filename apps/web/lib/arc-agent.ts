...
export const arcAgentValidationStorageKey = 'arc-usdc-rebalancer:arc-agent-validation-request-hash'
...
export const arcAgentActivationReputationTag = 'dashboard_activation'
export const arcAgentValidationRequestHash = keccak256(
  toHex(`kyc_verification_request_agent_${arcAgentId.toString()}`),
)

export function makeArcAgentActivationRequestHash(seed: string) {
